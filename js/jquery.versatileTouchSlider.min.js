    ...
    e.versatileTouchSlider = function(t, n) {
        function q() {
            ...
            for (var r = 0; r < k.length; r++) {
                ...
                i.stop().delay(140 * r).animate({
                    opacity: 1
                }, {
                    duration: 500
                });
                s.stop().delay(240 * r).animate({
                    opacity: .8
                }, {
                    duration: 1e3
                });
        ...
        function z() {
            e("#" + R).css({
                top: (b.height() - e("#" + R).height()) / 2
            });
            e("#" + U).css({
                top: (b.height() - e("#" + U).height()) / 2
            })
        }
        ...
        if (E > 0) {
            ...
            if (m == "image_shelf") {
                b.css({
                    background: "#000 url(img/texture_01_dark.jpg)"
                })
            }
            if (m == "image_banner") {
                w.css({
        ...
        pt.on("click", function(n) {
            function f(t) {
                ...
                e("#sti_previous_lightbox").css({
                    opacity: 0,
                    display: "none"
                });
                e("#sti_next_lightbox").css({
                    opacity: 0,
                    display: "none"
                });
                ...
                i.mouseover(function(t) {
                    ...
                    e("#sti_previous_lightbox").stop().animate({
                        opacity: 0
                    }, {
                        duration: 400
                    });
                    e("#sti_next_lightbox").stop().animate({
                        opacity: 0
                    }, {
                        duration: 400
                    })
            ...
            function l(t, n, r, i) {
                ...
                u.stop().delay(100).animate({
                    ...
                    u.append("<div id='close_btn_lightbox'></div>");
                    var s = parseInt(u.css("padding-left"));
                    e("#sti_bar_lightbox").css({
                        width: t + s,
                        bottom: -(s * 2) - 31,
                        left: 0
                    });
            ...
            e("#mask_lightbox").click(function() {
                 c()  //  这里注释的话就只允许点击关闭按钮才会关闭音乐条，点击关闭按钮外的不允许。但这里是读书，观影，音乐公用，还是开启吧
            });
        ...
        e(window).on("resize", function(n) {
            ...
            if (bt == undefined || bt != r || wt == undefined || wt != i) {
                ...
                if (e("#popup_lightbox").length > 0) {
                    ...
                    a.css({
                        top: e(window).height() / 2 - a.height() / 2,
                        left: e(window).width() / 2 - a.width() / 2
                    });
