...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function(a, b, c, d, e, g) {
        ...
        if (a.isVideo) {
            f =
                b.videoWidth > 0 ? b.videoWidth : c.getAttribute("width") !== null ? c.getAttribute("width") : b.defaultVideoWidth;
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        setPlayerSize: function(a, b) {
            ...
            if (this.height.toString().indexOf("%") > 0 || this.$node.css("max-width") === "100%") {
                var c = this.media.videoWidth && this.media.videoWidth > 0 ? this.media.videoWidth :
...
(function(f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function(a, b) {
            for (var c = this, e = "", d = c.options.contextMenuItems, g = 0, k = d.length; g <
                k; g++)
